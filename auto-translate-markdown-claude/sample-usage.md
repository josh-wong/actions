...
jobs:
  translate-markdown:
    ...
    uses: josh/actions/.github/workflows/auto-translate-markdown-claude-reusable.yml@main
    secrets:
...
# Optional: Enhanced GitHub token for enterprise features
GH_ENTERPRISE_TOKEN=ghp_...         # GitHub Enterprise token (if needed)
```
